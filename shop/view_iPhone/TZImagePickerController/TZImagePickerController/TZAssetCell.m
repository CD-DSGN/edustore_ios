...
@property (assign, nonatomic) UIImageView *imageView;       // The photo / 照片
@property (assign, nonatomic) UIImageView *selectImageView;
@property (assign, nonatomic) UIView *bottomView;
@property (assign, nonatomic) UILabel *timeLength;

@property (nonatomic, assign) UIImageView *viewImgView;
...
@property (assign, nonatomic) UIImageView *posterImageView;
@property (assign, nonatomic) UILabel *titleLable;
