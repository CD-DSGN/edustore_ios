//
//  SinglePhotoBrowerViewController.m
//  shop
//
//  Created by 田明飞 on 2017/1/20.
//  Copyright © 2017年 geek-zoo studio. All rights reserved.
//

#import "SinglePhotoBrowerViewController.h"

@interface SinglePhotoBrowerViewController ()<UIScrollViewDelegate>
...
@implementation SinglePhotoBrowerViewController
...
-(void)addSubViews
{
    ...
    for (int i=0; i<_imageArray.count; i++) {
        ...
        _imageView=[[BeeUIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
        [_imageView retain];
        _imageView.userInteractionEnabled = YES;
        [_imageView setUrl:[_imageArray[i] objectForKey:@"img"]];
...
//    [imageView setTransform:CGAffineTransformScale(imageView.transform, 3, 3)];
}
